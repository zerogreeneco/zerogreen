...
nohup java -jar $REPOSITORY/zerogreen.war \
  -Dspring.config.location=/home/ec2-user/app/application.properties,/home/ec2-user/app/application-$IDLE_PROFILE.properties,/home/ec2-user/app/application-oauth.properties,/home/ec2-user/app/application-real-db.properties \

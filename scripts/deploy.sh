...
nohup java -jar \
    -Dspring.config.location=classpath:/home/ec2-user/app/application.properties,classpath:/application-real.properties,/home/ec2-user/app/application-oauth.properties,/home/ec2-user/app/application-real-db.properties \
